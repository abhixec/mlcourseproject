...
First, we load the data both from the provided training and test data provided to us.
Some values are a  "#DIV/0!" that are replaced with an NA value.
...
We later cast all columns 8 to the end to be numeric.
...
Some columns were mostly blank and dont contribute to the prediction.  I chose a feature
